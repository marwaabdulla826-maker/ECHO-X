...
for device in devices:
    ...
    # IMPORTANT:
    # NetworkScanner uses "open_ports"
    ports = device.get(
        "open_ports",
        device.get(
            "ports",
                ...
                try:
                    ...
                    if not cycle_result:
                        ...
                        with d2:
                            ...
                            st.metric(
                                "Fusion Score",
                                f"{safe_number(selected_defense.get('fusion_score', 0)):.2f}"
                            )
                        ...
                        with d3:
                            ...
                            st.metric(
                                "Confidence",
                                f"{safe_number(selected_defense.get('confidence', 0)):.2f}%"
                            )
                        ...
                        with d4:
                            ...
                            st.metric(
                                "Effectiveness",
                                f"{safe_number(selected_defense.get('effectiveness', 0)):.2f}%"
                            )
...
if defense_result:
    ...
    with c2:
        ...
        st.metric(
            "Fusion Score",
            f"{safe_number(selected.get('fusion_score', 0)):.2f}"
        )
